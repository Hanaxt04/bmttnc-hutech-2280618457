...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_decrypt.setGeometry(QtCore.QRect(260, 340, 91, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.btn_decrypt.setFont(font)
        self.btn_decrypt.setStyleSheet("background-color: rgb(85, 170, 255);")
        self.btn_decrypt.setObjectName("btn_decrypt")
        self.txt_cipher_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(130, 230, 221, 91))
        self.txt_cipher_text.setStyleSheet("background-color: rgb(215, 243, 255)")
        self.txt_cipher_text.setObjectName("txt_cipher_text")
        self.txt_plain_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_plain_text.setGeometry(QtCore.QRect(130, 90, 221, 121))
        self.txt_plain_text.setStyleSheet("background-color: rgb(215, 243, 255)")
        self.txt_plain_text.setObjectName("txt_plain_text")
        self.btn_encrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_encrypt.setGeometry(QtCore.QRect(130, 340, 91, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.btn_encrypt.setFont(font)
        self.btn_encrypt.setStyleSheet("background-color: rgb(85, 170, 255);")
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(310, 40, 231, 21))
        font = QtGui.QFont()
        ...
        self.txt_sign.setGeometry(QtCore.QRect(510, 230, 221, 91))
        ...
        self.txt_info.setGeometry(QtCore.QRect(510, 90, 221, 121))
        self.txt_info.setStyleSheet("background-color: rgb(215, 243, 255)")
        self.txt_info.setObjectName("txt_info")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(390, 230, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_5.setFont(font)
        self.label_5.setObjectName("label_5")
        self.btn_sign = QtWidgets.QPushButton(self.centralwidget)
        self.btn_sign.setGeometry(QtCore.QRect(510, 340, 91, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_3.setGeometry(QtCore.QRect(390, 90, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.btn_verify = QtWidgets.QPushButton(self.centralwidget)
        self.btn_verify.setGeometry(QtCore.QRect(640, 340, 91, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.btn_gen_keys.setGeometry(QtCore.QRect(490, 50, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
